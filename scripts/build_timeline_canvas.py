      ...
      {mounted && (
        <div className="absolute inset-0 flex flex-col items-center justify-center z-[5] px-4">
          ...
          <div className="animate-fade-up flex flex-col items-center justify-center mb-8 mt-12">
            {/* INLINE SVG LOGO */}
            <div className="relative w-32 h-32 md:w-40 md:h-40 mb-6 flex items-center justify-center filter drop-shadow-[0_0_20px_rgba(20,174,180,0.6)]">
              <svg viewBox="0 0 200 200" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="50" cy="90" r="6" fill="#1b75d6" />
                <circle cx="150" cy="90" r="6" fill="#1b75d6" />
                <circle cx="115" cy="45" r="6" fill="#1b75d6" />
                <circle cx="85" cy="45" r="6" fill="#1b75d6" />
                <circle cx="70" cy="110" r="6" fill="#1b75d6" />
                <circle cx="130" cy="110" r="6" fill="#1b75d6" />
                <circle cx="145" cy="125" r="6" fill="#1b75d6" />
                <circle cx="95" cy="155" r="6" fill="#1b75d6" />
                <path d="M 50 90 L 50 65 L 85 45 M 150 90 L 150 65 L 115 45 M 50 95 L 50 110 L 95 155 M 150 95 L 150 110 L 145 125" stroke="#1b75d6" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M 100 20 L 160 45 L 160 110 C 160 140 100 180 100 180 C 100 180 40 140 40 110 L 40 45 Z" stroke="#1b75d6" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M 100 35 L 140 55 L 140 105 C 140 125 100 160 100 160 C 100 160 60 125 60 105 L 60 55 Z" stroke="#1b75d6" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
...
print("Hero.tsx successfully updated with 80-second TimelineCanvas.")
