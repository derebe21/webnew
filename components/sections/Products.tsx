                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    isActive
                                        ? "bg-[#2563EB]/10 border-[#2563EB] text-white shadow-[0_0_20px_rgba(var(--itsec-primary),0.3)]"
                        ...
                        <div className="md:w-3/5 p-8 md:p-12 flex flex-col justify-center bg-gradient-to-br from-[#0F172A] to-[#0B1220]">
                            ...
                            <div className="flex flex-wrap items-center gap-4 mt-auto">
                                <Link
                                    ...
                                    className="inline-flex items-center px-8 py-4 bg-[#2563EB] hover:bg-[#1D4ED8] text-white rounded-xl font-bold transition-all transform hover:scale-105 shadow-[0_0_20px_rgba(var(--itsec-primary),0.4)]"
                                >
