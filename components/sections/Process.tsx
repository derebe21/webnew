  ...
  const steps = [
    {
      ...
      color: 'blue',
      accent: '#2563EB',
      glow: 'rgba(var(--itsec-primary),0.25)',
    ...
    },
    {
      ...
      border: 'border-cyan-500/25 hover:border-itsec-primary/50',
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:flex absolute top-[4.5rem] left-[33%] right-[33%] items-center justify-center pointer-events-none z-10">
            <div className="flex-1 h-px bg-gradient-to-r from-blue-500/40 via-cyan-400/40 to-indigo-500/40 relative">
              <ArrowRight className="absolute right-0 top-1/2 -translate-y-1/2 w-3 h-3 text-itsec-primary/60" />
            </div>
          </div>
            ...
            >
              ...
              <div className="p-8 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-3">
                  <h3 className="text-xl font-bold text-white tracking-tight leading-tight group-hover:text-itsec-primary transition-colors"
                      style={{fontFamily:'var(--font-montserrat,Montserrat,sans-serif)'}}>
                    {step.title}
                  </h3>
        ...
        <div className={`mt-20 flex flex-col sm:flex-row items-center justify-between gap-6 p-8 rounded-3xl border border-slate-800/60 bg-gradient-to-r from-slate-900/60 to-slate-950/60 backdrop-blur-md transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          <div className="flex flex-col gap-1.5 text-center sm:text-left">
            <div className="flex items-center gap-2 justify-center sm:justify-start">
              <Zap className="w-4 h-4 text-itsec-primary" />
              <span className="text-sm font-bold text-itsec-primary tracking-widest uppercase">Ready to Start?</span>
            </div>
          ...
          <a
            ...
            style={{
              ...
              boxShadow: '0 8px 32px rgba(var(--itsec-primary),.4)',
