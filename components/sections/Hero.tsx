    ...
    >
      ...
      >
            ...
            >
              <div className="p-1 px-4 border-l-4 border-blue-600 bg-white/5 backdrop-blur-md rounded-r-xl">
                <p className="text-xl sm:text-2xl text-slate-200 leading-relaxed font-medium tracking-wide py-4">
                  ITSEC Technology empowers businesses worldwide with robust digital infrastructure and advanced cybersecurity solutions.
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <Button
            size="lg"
            onClick={() => router.push('/data-center-construction')}
